...
exports.appointmentRequestRejectedTemplate = exports.appointmentRequestConfirmedTemplate = exports.invoiceEmailTemplate = exports.estimateEmailTemplate = exports.appointmentCreatedTemplate = void 0;
...
const baseLayout = (title, body, settings) => {
...
const appointmentCreatedTemplate = (data) => {
    const body = `
...
exports.appointmentCreatedTemplate = appointmentCreatedTemplate;
const estimateEmailTemplate = (data) => {
    const body = `
...
exports.estimateEmailTemplate = estimateEmailTemplate;
...
const appointmentRequestConfirmedTemplate = (data) => {
    const body = `
    <p>Hola ${data.clientName},</p>
...
exports.appointmentRequestConfirmedTemplate = appointmentRequestConfirmedTemplate;
const appointmentRequestRejectedTemplate = (data) => {
    const body = `
    <p>Hola ${data.clientName},</p>
...
exports.appointmentRequestRejectedTemplate = appointmentRequestRejectedTemplate;
